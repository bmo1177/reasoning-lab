...
export default {
  ...
  theme: {
    ...
    extend: {
      /* ── Colour tokens (CSS-variable backed for light/dark) ── */
      colors: {
        ...
        supports: {
          strong: "hsl(var(--supports-strong))",
          weak: "hsl(var(--supports-weak))",
        },
        contradicts: "hsl(var(--contradicts))",
      ...
      fontFamily: {
        heading: ["DM Sans", "Figtree", "sans-serif"],
